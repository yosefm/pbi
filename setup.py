"""
I don't think setup is strictly necessary for this one, but some find it 
convenient.
"""
...
setup(
    ...
    description='The Particle Bureau of Investigation',
    ...
    install_requires=['numpy', 'scipy', 'optv'], # Maybe not SciPy. Need to check.
